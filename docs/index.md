...
[How to cite SWUIFT](citation-license.md#how-to-cite-swuift).
...
<div class="swuift-model-loop" markdown="0">
  <img class="swuift-model-loop--light" src="https://swuift.github.io/assets/swuift-model-loop-light.svg" alt="The SWUIFT simulation loop" width="100%">
  <img class="swuift-model-loop--dark" src="https://swuift.github.io/assets/swuift-model-loop-dark.svg" alt="The SWUIFT simulation loop" width="100%">
</div>
